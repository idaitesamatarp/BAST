    ...
    <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3" >
                <h4 class="m-0 font-weight-bold text-primary">Chat Pelanggan</h4> 
                <?php echo $this->session->flashdata('notif') ?>
            </div>
                <div class="card-body">
                    <p>Silahkan Pilih Pelanggan</p>
                    <table style="width: 100%" id="table-friend">
                        <?php foreach ($pelanggan as $item) { ?>
                        <tr>
                            <td><a href="javascript:;" data-friend="<?= $item->id_user ?>"><?= $item->nama_pel ?></a></td>
                        </tr>
                        <?php } ?>
                    </table>
                </div>
...
<div id="wgt-container-template" style="display: none">
    <div class="msg-wgt-container">
        <div class="msg-wgt-header">
            ...
            <a href="javascript:;" class="nama_pel"></a>
...
jQuery(document).ready(function($) {
    ...
    // Minimize Maximize
    $(document).on('click', '.msg-wgt-header > a.nama_pel', function() {
