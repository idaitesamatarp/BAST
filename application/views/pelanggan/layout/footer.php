    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-danger" href="<?php echo base_url() ?>pelanggan/dashboard/logout">Logout</a>
        </div>
      </div>
    </div>
  </div>
    ...
    $("#btnSaveSign").click(function(e){
      html2canvas([document.getElementById('sign-pad')], {
        onrendered: function (canvas) {
          ...
          $.ajax({
            url: '<?php echo base_url()?>pelanggan/bast/save_sign/<?=$id?>',
            data: { img_data:img_data },
            type: 'post',
            dataType: 'json',
            success: function (response) {
              //window.location.href="<?php echo base_url()?>pelanggan/bast/download";
              window.open("<?php echo base_url()?>pelanggan/bast/laporan_pdf");
            }
          });
        }
      });
