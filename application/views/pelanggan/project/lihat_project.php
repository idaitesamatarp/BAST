        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
              <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Your Data Project</h6>
          </div>
        <div class="card-body">
            <div class="col-md-12">
            <?php echo form_open_multipart('pelanggan/projet/lihat')?>
                ...
                <div class="form-group">
                 ...
                 <a href="<?php echo base_url() ?>pelanggan/dashboard" class="btn btn-sm btn-primary"> <span class="fa fa-arrow-left"></span> Back</a>
                <?php echo form_close() ?>
            </div>
        </div>
    </div>
