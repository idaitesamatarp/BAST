...
class Account extends CI_Controller 
{
    ...
    public function index()
    {
        ...
        $data=array (
            ...
            'isi'       =>'programmer/account/profile',
            'data_programmer'  =>$this->model_account->get_all($id_user),
    ...
    public function edit($id_user)
    {
        ...
        $data = array(
            'title'     => 'Profile programmer',
            'isi'       => 'programmer/account/profile',
            'data_programmer' => $this->model_account->edit($id_user)
